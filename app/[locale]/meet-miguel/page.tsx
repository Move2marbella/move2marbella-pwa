...
const meetContent: Record<Locale, MeetContent> = {
  ...
  hu: {
    ...enContent,
    body: "A Move2Marbella alapítójaként Zsolt abban segít, hogy jó környéket, reális árat és hosszú távon is védhető döntést válassz.",
    buyerEyebrow: "Vevői kérdések",
    buyerQuestions: ["Melyik környék illik az életmódodhoz vagy befektetési célodhoz?", "Az ingatlan valóban jó helyen van, vagy csak jól van tálalva?", "Milyen valós vételi és fenntartási költségek vannak?", "Milyen az újraeladási vagy kiadási logika?", "Van-e mikro-lokációs, community vagy árszint kockázat?", "A shortlist a hosszú távú célokat szolgálja?"],
    buyerTitle: "Kérdések egy magabiztos vásárláshoz",
    eyebrow: "Costa del Sol vevői tanácsadó",
    faqEyebrow: "Rövid válaszok",
    faqTitle: "Miguel és a Move2Marbella",
    metaDescription: "Ismerd meg Miguel Zsolt Horváth-ot, a Move2Marbella alapítóját és Costa del Sol vevői tanácsadót.",
    methodEyebrow: "Move2Marbella módszer",
    methodTitle: "Strukturált ingatlan-összehasonlítás",
    proofCards: [
      { title: "Costa del Sol tapasztalat 2010 óta", text: "Miguel Zsolt nemzetközi vevőknek segít Marbella, Estepona, Benahavís, Nueva Andalucía, Golden Mile és más prime területeken." },
      { title: "Orvos és közgazdász háttér", text: "Az orvosi és közgazdasági gondolkodás rendszerezett, elemző döntéstámogatást ad egy dinamikusan fejlődő piacon." },
    ...
    faqs: [
      ...
      { question: "Miben más a Move2Marbella?", answer: "Vevői támogatással dolgozunk: környék, mikrolokáció, költségek és újraeladást is figyelembe vesszük." },
      { question: "Mely területekre fókuszál?", answer: "Marbella, Estepona, Benahavís, Nueva Andalucía, Golden Mile, San Pedro és más népszerű Costa del Sol területek." },
