...
export const translations: Record<Locale, Translation> = {
  ...
  es: {
    ...
    valuation: {
      ...
      formBeachfront: "Posición de playa",
  ...
  ru: {
    ...
    valuation: {
      ...
      formBeachfront: "Положение у пляжа",
  ...
  pl: {
    ...
    valuation: {
      ...
      formBeachfront: "Położenie przy plaży",
  ...
  hu: {
    ...
    valuation: {
      ...
      formBeachfront: "Tengerparti pozíció",
